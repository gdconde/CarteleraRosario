...
/**
 * Provide "make" methods to create instances of {@link TheMovieDbService}
 * and its related dependencies, such as OkHttpClient, Gson, etc.
 */
public class TheMovieDbServiceFactory {

    public static TheMovieDbService makeSecretsService() {
        OkHttpClient okHttpClient = makeOkHttpClient(makeLoggingInterceptor());
        return makeTheMovieDbService(okHttpClient, makeGson());
    }

    public static TheMovieDbService makeTheMovieDbService(OkHttpClient okHttpClient, Gson gson) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(BuildConfig.THEMOVIEDB_URL)
                .client(okHttpClient)
